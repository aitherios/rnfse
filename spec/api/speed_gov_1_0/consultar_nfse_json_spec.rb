...
describe "speed_gov_1_0/consultar_nfse.json" do
  let(:file) do 
    File.join($ROOT, 'lib', 'rnfse', 'api', 'speed_gov_1_0', 
              'consultar_nfse.json')
  end
  ...
  describe "#/" do
    ...
    it 'não deveria validar as datas' do
      expect(JSON::Validator.fully_validate(file, <<-'JSON')).not_to be_empty
        {
          "prestador": {
            "cnpj": "12.552.510/0001-50",
            "inscricaoMunicipal": "68"
